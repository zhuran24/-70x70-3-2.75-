...
* **实例上界设定** `[provisional]`：基地总格数 4900，单桩覆盖 144，理论下界约 35。为避开实体障碍与减少边缘碎片浪费，设定候选上限为 **50 个**。
...
* **实例上界设定** [provisional]：单箱每 10 秒清仓 300 个物品，算力远超全场 1.15 个/Tick 的产出。为给予路由布线“就近倾倒”的拓扑灵活性，设定候选上限为 **10 个**。
